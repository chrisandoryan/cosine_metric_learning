...
import train_app
from datasets import camstroke
...
class Camstroke(object):
    ...
    def read_train(self):
        filenames, ids, camera_indices = camstroke.read_train_split_to_str(
            self._dataset_dir)
    ...
    def read_test(self):
        return camstroke.read_test_split_to_str(self._dataset_dir)
...
def main():
    ...
    if args.mode == "train":
        ...
        train_app.train_loop(
            ...
            num_images_per_id=4, image_shape=camstroke.IMAGE_SHAPE,
            **train_kwargs)
    elif args.mode == "eval":
        ...
        gallery_features = train_app.encode(
            ...
            gallery_filenames, image_shape=camstroke.IMAGE_SHAPE)
        sio.savemat(
        ...
        query_features = train_app.encode(
            net.preprocess, network_factory, args.restore_path,
            query_filenames, image_shape=camstroke.IMAGE_SHAPE)
        sio.savemat(
        ...
        train_app.finalize(
            ...
            image_shape=camstroke.IMAGE_SHAPE,
            output_filename="./camstroke.ckpt")
